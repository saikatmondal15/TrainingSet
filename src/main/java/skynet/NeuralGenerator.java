...
/**
 * The main class for the program. The purpose of this program is the train an
 * Artificial Neural Network and output source code for it, so that it can be
...
public class NeuralGenerator {
	...
	/**
	 * The type of network the ANN will be (0: Resilient propagation, 1:
	 * backpropagation)
	 */
